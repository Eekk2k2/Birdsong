...
//	this->depthMaterial->shader->SetVec3("lightPos", this->lightPosition);
//	this->depthMaterial->shader->SetFloat("farPlane", this->renderPlanes.y);
//
...
//void Light::Render(std::unordered_map<std::string, PipelineElement>& m_renderPipelineList) { /* Nothing */ }

//int Light::GetDepthMap() { return 0; }
//
//std::size_t Light::GetLightSpaceMatrixSize() { return 0; }
//
//std::vector<glm::mat4> Light::GetLightSpaceMatrix() { return std::vector<glm::mat4>(); }
//
//glm::mat4 Light::GetLightProjection() { return glm::mat4(); }
