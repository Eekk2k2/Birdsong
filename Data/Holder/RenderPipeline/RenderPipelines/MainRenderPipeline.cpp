...
//		renderPipelineMaterialElement.second.material->shader->SetVec3("lightPositions[0]", this->renderPipelineLights.begin()->second->GetPosition());
...
//		//renderPipelineMaterialElement.second.material->shader->SetMat4("lightSpaceMatrix", this->renderPipelineLights.begin()->second->GetLightSpaceMatrix()[0]);
//		//renderPipelineMaterialElement.second.material->shader->SetMat4("lightSpaceMatrix", this->renderPipelineLights.begin()->second->GetLightSpaceMatrix());
//
